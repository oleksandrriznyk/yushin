package ua.library.security;

import ua.library.security.bCrypt.BCrypt;
...
public class Password {
	...
	public static void main(String[] args) {
		...
		String computed_hash2 = hashPassword("pass1");
		System.out.println("Test computed hash: " + computed_hash2);
